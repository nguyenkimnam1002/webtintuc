          ...
          <div class="col-sm-16">
            <div class="row">
              <div class="sec-topic col-sm-16  wow fadeInDown animated " data-wow-delay="0.5s">
                <div class="row">
                  <div class="col-sm-16"> <img width="1000" height="606" alt="" src="./assets/images/sec/sec-3.jpg" class="img-thumbnail"> </div>
              ...
              <div class="col-sm-16 author-box">
                <div class="row">
                  <div class=" col-xs-4 col-sm-2"><img class="img-thumbnail" src="./assets/images/comments/com-1.jpg" width="128" height="128" alt="" /></div>
              ...
              <div class="col-sm-16 related">
                ...
                <div class="row">
                  <div class="item topic col-sm-5 col-xs-16"> <a href="#"> <img class="img-thumbnail" src="./assets/images/sec/sec-1.jpg" width="1000" height="606" alt="" />
                  ...
                  <div class="item topic col-sm-5 col-xs-16"> <a href="#"> <img class="img-thumbnail" src="./assets/images/sec/sec-2.jpg" width="1000" height="606" alt="" />
                      <h4>Etiam rhoncus. Maecenas tempus, tellus eget condimentum</h4>
                      <div class="text-danger sub-info-bordered remove-borders">
                        <div class="time"><span class="ion-android-data icon"></span>Dec 9 2014</div>
                        <div class="comments"><span class="ion-chatbubbles icon"></span>204</div>
                  ...
                  <div class="item topic col-sm-5 col-xs-16"> <a href="#"> <img class="img-thumbnail" src="./assets/images/sec/sec-3.jpg" width="1000" height="606" alt="" />
                      <h4>Etiam rhoncus. Maecenas tempus, tellus eget condimentum</h4>
                      <div class="text-danger sub-info-bordered remove-borders">
                        <div class="time"><span class="ion-android-data icon"></span>Dec 9 2014</div>
                        <div class="comments"><span class="ion-chatbubbles icon"></span>204</div>
              ...
              <div class="col-sm-16 comments-area">
                ...
                <div class="opinion pull-left">
                  ...
                  <div class="media"> <a href="#" class="pull-left"> <img alt="64x64" data-src="holder.js/64x64" class="media-object" style="width: 64px; height: 64px;" src="./assets/images/comments/com-2.jpg"> </a>
                    <div class="media-body">
                      <div>
                        <h4 class="media-heading">John Doe</h4>
                        <div class="time text-danger"><span class="ion-android-data icon"></span>Dec 9 2014</div>
                      ...
                      <div class="col-sm-16"><a href="#"><span class="reply pull-right ion-ios7-compose"></span></a></div>
                      <div class="media nested-rep pull-left"> <a href="#" class="pull-left"> <img alt="64x64" class="media-object" style="width: 64px; height: 64px;" src="./assets/images/comments/com-1.jpg"> </a>
                        <div class="media-body ">
                          <div>
                            <h4 class="media-heading">John Doe</h4>
                            <div class="time text-danger"><span class="ion-android-data icon"></span>Dec 9 2014</div>
