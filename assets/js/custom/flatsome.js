...
, function(t, e, i) {
    ...
    function(n, o) {
        r = o,
        !(d = "function" == typeof r ? r.call(e, i, e, t) : r)
    }(window, function() {
        "use strict";
        function t(t) {
            this.parent = t,
...
, function(t, e, i) {
    ...
    !function(s) {
        ...
        var e, i, n, o, r, s, a = "Close", l = "BeforeClose", c = "AfterClose", u = "BeforeAppend", d = "MarkupParse", h = "Open", p = "Change", f = "mfp", m = "." + f, g = "mfp-ready", v = "mfp-removing", y = "mfp-prevent-close", b = function() {}, w = !!window.jQuery, x = t(window), S = function(t, i) {
            e.ev.on(f + t + m, i)
        }, C = function(e, i, n, o) {
        ...
        b.prototype = {
            ...
            open: function(i) {
                ...
                k("BeforeOpen"),
                e.st.showCloseBtn && (e.st.closeBtnInside ? (S(d, function(t, e, i, n) {
                ...
                getInline: function(i, n) {
                    ...
                    i.src) {
                        ...
                        if (r.length) {
                            ...
                            s && s.tagName && (j || (_ = o.hiddenClass,
                            j = C(_),
                            _ = "mfp-" + _),
                            I = r.after(j).detach().removeClass(_)),
                    ...
                    var i = 0
                      ...
                      , o = function(r) {
                        ...
                        Q = setInterval(function() {
                            return n.naturalWidth > 0 ? void e._onImageHasSize(t) : (i > 200 && clearInterval(Q),
                            i++,
        ...
        t.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function(i) {
                    ...
                    return N() ? a["-moz-transform"] = a.transform = "translate(" + o.left + "px," + o.top + "px)" : (a.left = o.left,
                    a.top = o.top),
                    a
                }
            }
        ...
        e.prototype.refresh = function() {
            ...
            for (var r in t) {
                ...
                for (var a in this.waypoints[r]) {
                    ...
                    d = c && u,
                    h = !c && !u,
                    !v && d ? (p.queueTrigger(s.backward),
                    n[p.group.id] = p.group) : !v && h ? (p.queueTrigger(s.forward),
    ...
    !function(t, e, i) {
        ...
        n.prototype = {
                ...
                n.options.functionBefore.call(n.$el, n.$el, function() {
                    if (n.enabled && null !== n.Content) {
                        ...
                        if ("hidden" !== n.Status) {
                            ...
                            if (n.$tooltip = t('<div class="tooltipster-base ' + n.options.theme + '" style="' + u + " " + d + " " + h + " " + l + '"><div class="tooltipster-content"></div></div>'),
            ...
            reposition: function() {
                ...
                function n(i, n) {
                    a.offset.top - t(e).scrollTop() - c - A - 12 < 0 && n.indexOf("top") > -1 && (D = i),
                    a.offset.top + a.dimension.height + c + 12 + A > t(e).scrollTop() + t(e).height() && n.indexOf("bottom") > -1 && (D = i,
                ...
                if (0 !== t("body").find(o.$tooltip).length) {
                    ...
                    if ("top-left" == D && (_ = a.offset.left + O,
                    I = a.offset.top - c - A - 12,
                    i(),
                    n("bottom-left", "top-left")),
                    "top-right" == D && (_ = a.offset.left + a.dimension.width + O - l,
                    I = a.offset.top - c - A - 12,
                    i(),
                    ...
                    if ("bottom-left" == D && (_ = a.offset.left + O,
                    I = a.offset.top + a.dimension.height + A + 12,
                    i(),
                    n("top-left", "bottom-left")),
                    "bottom-right" == D && (_ = a.offset.left + a.dimension.width + O - l,
                    I = a.offset.top + a.dimension.height + A + 12,
                    i(),
                    ...
                    "left" == D) {
                        ...
                        _ < 0 && j + l > s) {
                            ...
                            _ < 0 && (_ = a.offset.left + O + a.dimension.width + 12,
                            r = "left")
                    }
                    if ("right" == D) {
                    ...
                    if (o.options.arrow) {
                        ...
                        else if ("bottom" == D || "bottom-left" == D || "bottom-right" == D)
                        ...
                        if (0 !== N) {
                            var $ = ""
                              , V = "border-color: " + B + ";";
                            F.indexOf("bottom") !== -1 ? $ = "margin-top: -" + Math.round(N) + "px;" : F.indexOf("top") !== -1 ? $ = "margin-bottom: -" + Math.round(N) + "px;" : F.indexOf("left") !== -1 ? $ = "margin-right: -" + Math.round(N) + "px;" : F.indexOf("right") !== -1 && ($ = "margin-left: -" + Math.round(N) + "px;"),
                            H = '<span class="tooltipster-arrow-border" style="' + $ + " " + V + ';"></span>'
                        }
...
, function(t, e, i) {
    ...
    t.exports = function(t, e, i, v, y, b, w) {
        ...
        }, E = e + " Iterator", T = y == m, P = !1, _ = t.prototype, j = _[d] || _[p] || y && _[y], I = j || k(y), A = y ? T ? k("entries") : I : void 0, O = "Array" == e ? _.entries || j : j;
        if (O && (C = u(O.call(new t)),
        C !== Object.prototype && C.next && (c(C, E, !0),
        n || "function" == typeof C[d] || s(C, d, g))),
        T && j && j.name !== m && (P = !0,
        I = function() {
            return j.call(this)
        }
...
, function(t, e, i) {
    var n = i(35)
      ...
      , l = "prototype"
      , c = function(t, e, i) {
        var u, d, h, p = t & c.F, f = t & c.G, m = t & c.S, g = t & c.P, v = t & c.B, y = t & c.W, b = f ? o : o[e] || (o[e] = {}), w = b[l], x = f ? n : m ? n[e] : (n[e] || {})[l];
        f && (i = e);
        for (u in i)
            d = !p && x && void 0 !== x[u],
            d && a(b, u) || (h = d ? x[u] : i[u],
            b[u] = f && "function" != typeof x[u] ? i[u] : v && d ? r(h, n) : y && x[u] == h ? function(t) {
                ...
                return e[l] = t[l],
                e
            }(h) : g && "function" == typeof h ? r(Function.call, h) : h,
            g && ((b.virtual || (b.virtual = {}))[u] = h,
            t & c.R && w && !w[u] && s(w, u, h)))
    };
    c.F = 1,
    c.G = 2,
...
, function(t, e, i) {
    ...
    : function(t) {
      ...
      , G = function(t, e, i) {
        ...
        e = x(e, !0),
        y(i),
        o(W, e) ? (i.enumerable ? (o(t, M) && t[M][e] && (t[M][e] = !1),
        i = C(i, {
            enumerable: S(0, !1)
        })) : (o(t, M) || j(t, M, S(1, {})),
        t[M][e] = !0),
      ...
      , Z = function(t, e) {
        ...
        t !== B || !o(W, e) || o(N, e)) {
            var i = _(t, e);
            return !i || !o(W, e) || o(t, M) && t[M][e] || (i.enumerable = !0),
            i
        }
    }
      , J = function(t) {
        for (var e, i = I(w(t)), n = [], r = 0; i.length > r; )
            o(W, e = i[r++]) || e == M || e == l || n.push(e);
        return n
    }
      , tt = function(t) {
        for (var e, i = t === B, n = I(i ? N : w(t)), r = [], s = 0; n.length > s; )
            !o(W, e = n[s++]) || i && !o(B, e) || r.push(W[e]);
        return r
    };
    H || (A = function() {
    ...
    i(84).f = K,
    i(83).f = tt,
    r && !i(33) && a(B, "propertyIsEnumerable", K, !0),
    f.f = function(t) {
        return q(p(t))
    }
    ),
    ...
    for (var et = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), it = 0; et.length > it; )
        p(et[it++]);
    for (var nt = P(p.store), ot = 0; nt.length > ot; )
        m(nt[ot++]);
    s(s.S + s.F * !H, "Symbol", {
        for: function(t) {
...
, function(t, e) {
    ...
    function i(t) {
        ...
        /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) || t.classList && t.dataset && (f.push({
            element: t,
            type: a(t)
        }),
        o(f[f.length - 1]))
    ...
    function s(t) {
        ...
        if (!(d.top > r || d.top + s.offsetHeight < 0))
            ...
            case "element":
                ...
                e.style.transform = o ? "translate3d(0, " + x.toFixed(2) + "px, 0)" : null,
                e.style.backfaceVisibility = o ? "hidden" : null,
                "undefined" != typeof e.dataset.parallaxFade && (e.style.opacity = o ? h(1 - w).toFixed(2) : null)
            }
    }
    function a(t) {
    ...
    function u(t) {
        for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null; t && !d(t).call(t, e); )
            t = t.parentElement;
        return t
    }
    function d(t) {
    ...
    var i = function(t) {
        ...
        function n(t, e) {
            function i() {
                ...
                n.height = l + "px",
                "left" === e["object-position-x"] ? n.marginLeft = 0 : "right" === e["object-position-x"] ? n.marginLeft = Math.round(a - u) + "px" : n.marginLeft = Math.round((a - u) / 2) + "px") : (d = a / s,
                n.width = a + "px",
                n.height = Math.round(d) + "px",
                "top" === e["object-position-y"] ? n.marginTop = 0 : "bottom" === e["object-position-y"] ? n.marginTop = Math.round(l - d) + "px" : n.marginTop = Math.round((l - d) / 2) + "px"),
                t.autoplay && t.play()
            }
            if ("fill" !== e["object-fit"]) {
                var n = t.style
...
, function(t, e, i) {
    ...
    !function(r, s) {
        ...
        var n = function(t, e, i, n, o, r) {
            ...
            for (var d = 0, h = ["webkit", "moz", "ms", "o"], p = 0; p < h.length && !window.requestAnimationFrame; ++p)
        ...
        attach: function(t) {
            jQuery(".tabbed-content", t).each(function(t, e) {
                ...
                o.each(function(t, e) {
                    ...
                    i(t, o, r)),
                    location.hash.substr(1).length && location.hash.substr(1) === e.hash.substr(1) && i(t, o, r),
...
, function(t, e) {
    ...
    Flatsome.behavior("scroll-to", {
        attach: function() {
            ...
            e.length && (e.children().tooltipster("destroy"),
            e.remove()),
            ...
            t.each(function(t, e) {
                ...
                if (jQuery("li.nav-single-page").before(c),
                setTimeout(function() {
                ...
                location.hash) {
                    ...
                    jQuery(function(t) {
                        return jQuery.scrollTo("a[name=" + u + "]", {
                            duration: 500,
                            axis: "y",
                            offset: -i
                        }),
    ...
    Flatsome.behavior("accordion", {
        attach: function(t) {
            jQuery(".accordion", t).each(function() {
                ...
                t > 0 && (jQuery(this).find(".accordion-item:nth-child(" + t + ") .accordion-inner").show(),
                jQuery(this).find(".accordion-item:nth-child(" + t + ") .accordion-inner").prev().addClass("active"))
            })
        }
    }),
        ...
        attach: function(t) {
            jQuery(".accordion-title", t).each(function(t) {
                jQuery(this).click(function(t) {
                    ...
                    jQuery(this).parent().parent().find("[data-flickity-options]").flickity("resize")) : jQuery(this).parent().parent().find(".accordion-title").removeClass("active").next().slideUp(200),
                    t.preventDefault()
                })
            })
        }
